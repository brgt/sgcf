...
/// <summary>
/// Fixture exclusiva do módulo LimitesGlobaisBanco — container PostgreSQL isolado para não
/// interferir nas fixtures de Cotações ou LimitesBanco.
/// Marcada [Slow] — exclua do loop rápido com --filter "Category!=Slow".
/// </summary>
public sealed class LimitesGlobaisBancoApiFixture : IAsyncLifetime
{
    private readonly PostgreSqlContainer _db = new PostgreSqlBuilder()
        .WithImage("postgres:16-alpine")
        .WithDatabase("sgcf_limites_globais_e2e")
        .WithUsername("sgcf")
        .WithPassword("sgcf_limites_globais_e2e")
        .Build();
...
[CollectionDefinition("LimitesGlobaisBancoApi")]
#pragma warning disable CA1711
public sealed class LimitesGlobaisBancoApiGroup : ICollectionFixture<LimitesGlobaisBancoApiFixture> { }
